...
- Add `swift.disableAutoSwiftlyToolchainInstall` setting to skip automatically installing a missing Swift toolchain via Swiftly and notify the user to install it manually instead
