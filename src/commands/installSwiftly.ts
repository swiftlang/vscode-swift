...
export async function promptForSwiftlyInstallation(
    ...
    const installMessage = `Swiftly is not installed on your system. Swiftly is a Swift toolchain installer and manager that allows you to easily install and switch between different versions of Swift.

Would you like to install Swiftly now?`;
