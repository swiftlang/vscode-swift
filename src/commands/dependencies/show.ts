 ...
 */
export async function showPackageDependencies(folderContext: FolderContext): Promise<Dependency[]> {
    const result = await executeSwiftPackageCommand<{ dependencies: Dependency[] }>(folderContext, {
